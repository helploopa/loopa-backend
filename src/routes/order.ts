...
import { runFreeSampleSweep } from '../jobs/freeSampleSweep';
 ...
 *         schema:
 *           type: string
 *           enum: [All, CANCELLED, COMPLETED, CLOSED, APPROVED, REJECTED]
 ...
 *     description: |
 *       Runs the same job that executes nightly at midnight. Scans all completed/closed orders
